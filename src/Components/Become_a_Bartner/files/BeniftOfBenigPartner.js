  ...
  render(){
      return(
            ...
            <div class="d-flex flex-column mr-5">
                ...
                <div class="d-md-flex col-12  justify-content-between mt-5" >
                    <div class=" d-flex flex-column  col-md-4 ">
                        ...
                        <img class="mx-auto w-100 mt-4" style={{borderRadius:'7px'}} src={img_hiring} />
                    ...
                    <div class=" d-flex flex-column  col-md-4 ml-md-5 mr-md-5 ">
                        <img class="mx-auto w-100 mt-4 " style={{borderRadius:'7px'}} src={img_delivery} />
                    ...
                    <div class="d-flex flex-column col-md-4 justify-content-center">
                        ...
                        <h1 class="mx-auto  mb-4 ">Live tracking</h1>
        ...
        <div class="d-flex flex-column justify-content-between mt-5 pt-5">
            ...
            <Router>
            <HashLink class="btn mx-auto btn col-4 mt-5 mb-5 w-100"  smooth to='/MariamShalaby11/Talabat-React/BecomePartner/#BecomePartner' > <button class="mx-auto btn col-12 mt-5 mb-5 w-100">Join Now</button> </HashLink>
            </Router>
